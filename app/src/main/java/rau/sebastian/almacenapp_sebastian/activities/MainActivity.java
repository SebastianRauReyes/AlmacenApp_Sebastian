...
import rau.sebastian.almacenapp_sebastian.adapters.ProductosAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Bienvenido " + getIntent().getExtras().getString("name"), Toast.LENGTH_SHORT).show();
